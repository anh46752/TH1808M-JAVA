...
public class Array {
    ...
    public Array(int tu_so, int mau_so) {
        this.tu_so = tu_so;
        this.mau_so = mau_so;
    }
    ...
    public void sub(Array fraction){
        int tu_so = this.getTu_so()*fraction.getMau_so()
                - this.getMau_so()*fraction.getTu_so();
        int mau_so = this.getMau_so()*fraction.getMau_so();
    ...
    public void mul(Array fraction){
    ...
    public void div(Array fraction){
